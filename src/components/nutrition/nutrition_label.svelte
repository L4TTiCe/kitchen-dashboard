...
<div class="p-1 border-2 border-black font-sans w-72">
    ...
    <div class="flex justify-between font-bold border-b-8 border-black">
        <div>Serving size</div><div>{#if serving_size}{serving_size}{:else}{placeholder.serving_size}{/if} {#if serving_unit}{serving_unit}{:else}{placeholder.serving_unit}{/if}</div>
    </div>
    <div class="flex justify-between items-end font-extrabold">
        ...
        <div class="text-5xl">{#if calories}{calories}{:else}{placeholder.calories}{/if}</div>
    </div>
    <div class="border-t-4 border-black text-sm pb-1">
        ...
        <div class="flex justify-between">
            <div>
                <span class="font-bold">Total Fat</span> {#if total_fat}{total_fat}{:else}{placeholder.total_fat}{/if}g
            </div>
            <div class="font-bold">{#if total_fat}{((Number(total_fat) / 78) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between pl-4">
            <div>Saturated Fat {#if saturated_fat}{saturated_fat}{:else}{placeholder.saturated_fat}{/if}g</div>
            <div class="font-bold">{#if saturated_fat}{((Number(saturated_fat) / 20) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="pl-4">
            <span class="italic">Trans Fat</span> {#if trans_fat}{trans_fat}{:else}{placeholder.trans_fat}{/if}g
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between">
            <div>
                <span class="font-bold">Cholesterol</span> {#if cholesterol}{cholesterol}{:else}{placeholder.cholesterol}{/if}mg
            </div>
            <div class="font-bold">{#if cholesterol}{((Number(cholesterol) / 300) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between">
            <div>
                <span class="font-bold">Sodium</span> {#if sodium}{sodium}{:else}{placeholder.sodium}{/if}mg
            </div>
            <div class="font-bold">{#if sodium}{((Number(sodium) / 2300) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between">
            <div>
                <span class="font-bold">Total Carbohydrate</span> {#if total_carbohydrates}{total_carbohydrates}{:else}{placeholder.total_carbohydrates}{/if}g
            </div>
            <div class="font-bold">{#if total_carbohydrates}{((Number(total_carbohydrates) / 275) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between">
            <div class="pl-4">
            ...
            <div class="font-bold">{#if dietary_fiber}{((Number(dietary_fiber) / 28) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="pl-4">
        ...
        <div class="pl-8 flex justify-between">
            <span>Includes {#if added_sugar}{added_sugar}{:else}{placeholder.added_sugar}{/if}g Added Sugars</span>
            <div class="font-bold">{#if added_sugar}{((Number(added_sugar) / 50) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
        <hr class="border-gray-500"/>
        <div class="flex justify-between">
            <div>
                <span class="font-bold">Protein</span> {#if protein}{protein}{:else}{placeholder.protein}{/if}g
            </div>
            <div class="font-bold">{#if protein}{((Number(protein) / 50) * 100).toFixed(0)}{:else}0{/if}%</div>
        </div>
    <!-- </div>
