...
<ul class="flex my-3">
	<li class="flex-1 mr-2">
		<a class={active == 'add' ? active_classes : inactive_classes} href="/food/foodDB/add"
			>Add Food Item to FoodDB</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'update' ? active_classes : inactive_classes} href="/food/foodDB/update"
			>Update Food Item on FoodDB</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'delete' ? active_classes : inactive_classes} href="/food/foodDB/delete"
			>Remove Food Item from FoodDB</a
		>
	</li>
</ul>
