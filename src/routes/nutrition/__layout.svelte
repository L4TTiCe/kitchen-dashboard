...
<ul class="flex my-3">
	<li class="flex-1 mr-2">
		<a class={active == 'view' ? active_classes : inactive_classes} href="/nutrition/view"
			>View Nutrition</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'add' ? active_classes : inactive_classes} href="/nutrition/add"
			>Add Nutrition</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'update' ? active_classes : inactive_classes} href="/nutrition/update"
			>Update Nutrition</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'delete' ? active_classes : inactive_classes} href="/nutrition/delete"
			>Remove Nutrition</a
		>
	</li>
</ul>
