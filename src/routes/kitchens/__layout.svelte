...
<ul class="flex my-3">
	<li class="flex-1 mr-2">
		<a class={active == 'kitchen' ? active_classes : inactive_classes} href="/kitchens/kitchen"
			>Kitchen</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a class={active == 'location' ? active_classes : inactive_classes} href="/kitchens/locations"
			>Locations</a
		>
	</li>
</ul>
