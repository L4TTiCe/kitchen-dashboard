...
<ul class="flex my-3">
	<li class="flex-1 mr-2">
		<a class={active == 'add' ? active_classes : inactive_classes} href="/kitchens/locations/add"
			>Add Location to Kitchen</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a
			class={active == 'sub' ? active_classes : inactive_classes}
			href="/kitchens/locations/addSubLocation">Add Sub-Location</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a
			class={active == 'update' ? active_classes : inactive_classes}
			href="/kitchens/locations/update">Update Location</a
		>
	</li>
	<li class="flex-1 mr-2">
		<a
			class={active == 'delete' ? active_classes : inactive_classes}
			href="/kitchens/locations/delete">Delete Location</a
		>
	</li>
</ul>
