...
<form class="w-full max-w-lg mx-4">
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			...
			<input
				bind:value={upc}
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-upc"
				type="number"
				placeholder={placeholder.upc}
			/>
			<p class="text-gray-600 text-xs italic">
				Does this product have a Universal Product Code (UPC)?
			</p>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			<label
				class="{description == ''
					? 'border-red-500'
					: 'border-gray-200'} block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
				for="grid-username"
			>
				Description
			</label>
	...
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
			...
			<input
				...
				id="grid-serving-size"
				placeholder={placeholder.serving_size.toString()}
			/>
		</div>
		<div class="w-full md:w-1/2 px-3">
			...
			<input
				bind:value={serving_unit}
				type="text"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-serving-unit"
				placeholder={placeholder.serving_unit}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			...
			<input
				...
				id="grid-calories"
				type="number"
				placeholder={placeholder.calories.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			...
			<input
				bind:value={total_fat}
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-total_fat"
				type="number"
				placeholder={placeholder.total_fat.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
			<label
				class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
				for="grid-saturated_fat"
			>
				Saturated Fat (g)
			</label>
			<input
				bind:value={saturated_fat}
				type="number"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-saturated_fat"
				placeholder={placeholder.saturated_fat.toString()}
			/>
		</div>
		<div class="w-full md:w-1/2 px-3">
			<label
			...
			<input
				bind:value={trans_fat}
				type="number"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-trans_fat"
				placeholder={placeholder.trans_fat.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
			...
			<input
				...
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-saturated_fat"
				placeholder={placeholder.cholesterol.toString()}
			/>
		</div>
		<div class="w-full md:w-1/2 px-3">
			<label
			...
			<input
				...
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-trans_fat"
				placeholder={placeholder.sodium.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			<label
				class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
				for="grid-total_carbohydrates"
			>
				Total Carbohydrates (g)
			</label>
			<input
				bind:value={total_carbohydrates}
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-total_carbohydrates"
				type="number"
				placeholder={placeholder.total_carbohydrates.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
			...
			<input
				bind:value={dietary_fiber}
				type="number"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-dietary_fiber"
				placeholder={placeholder.dietary_fiber.toString()}
			/>
		</div>
		<div class="w-full md:w-1/3 px-3">
			...
			<input
				bind:value={total_sugar}
				type="number"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-total_sugar"
				placeholder={placeholder.total_sugar.toString()}
			/>
		</div>
		<div class="w-full md:w-1/3 px-3">
			<label
			...
			<input
				bind:value={added_sugar}
				type="number"
				class="border-gray-200 appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
				id="grid-added_sugar"
				placeholder={placeholder.added_sugar.toString()}
			/>
		</div>
	</div>
	<div class="flex flex-wrap -mx-3 mb-6">
		<div class="w-full px-3">
			...
			<input
				...
				id="grid-protein"
				type="number"
				placeholder={placeholder.protein.toString()}
			/>
		</div>
	</div>
	<!-- <div class="flex flex-wrap -mx-3 mb-6">
